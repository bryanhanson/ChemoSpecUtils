...
.ggAnnotate <- function(text, x, y, ...) {
  ...
  if (text == "cls") {
    ...
    cls_txt_grob <- textGrob("classical ellipses by group", x = 0.14, y = 0.95, just = "left", gp = gpar(fontsize = 10))
  ...
  if (text == "rob") {
    ...
    rob_txt_grob <- textGrob("robust ellipses by group", x = 0.14, y = 0.95, just = "left", gp = gpar(fontsize = 10))
  ...
  if (text == "both") {
    ...
    rob_txt_grob <- textGrob("robust ellipses by group", x = 0.14, y = 0.92, just = "left", gp = gpar(fontsize = 10))
