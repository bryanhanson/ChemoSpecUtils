# ChemoSpecUtils 1.0.0 2021-07-26
## Significant Changes
* Thanks to GSOC and Tejasvi Gupta, a number of functions in `ChemoSpec` gain the ability to produce `ggplot2` and/or `plotly` graphics, which required changes here in `ChemoSpecUtils`.  See the news file for `ChemoSpec` for more details.
